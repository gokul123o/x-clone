...
import PostInteractions from "./Postinterations";
...
type PostWithDetails = PostType &
  Engagement & {
    ...
    imgHeight?: number | null; // Ensure this property is optional
    isSensitive?: boolean;
  };
...
const Post = ({
  ...
  const originalPost = (post.rePost || post) as PostWithDetails;
          ...
          {originalPost.img && (
            <div className="overflow-hidden">
              <Image
                ...
                w={200} // Use nullish coalescing for better handling
